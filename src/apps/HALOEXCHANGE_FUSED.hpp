...
public:
  ...
  void runOpenMPVariantDefault(VariantID vid);
  template < size_t block_size >
  void runCudaVariantDefault(VariantID vid);
  template < size_t block_size >
  void runHipVariantDefault(VariantID vid);
  void runOpenMPTargetVariantDefault(VariantID vid);
