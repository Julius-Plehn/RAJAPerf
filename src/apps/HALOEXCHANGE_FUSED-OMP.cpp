...
void HALOEXCHANGE_FUSED::runOpenMPVariantDefault(VariantID vid)
{
...
void HALOEXCHANGE_FUSED::runOpenMPVariantFuncPtr(VariantID vid)
{
#if defined(RAJA_ENABLE_OPENMP) && defined(RUN_OPENMP)
...
void HALOEXCHANGE_FUSED::runOpenMPVariantVirtFunc(VariantID vid)
{
#if defined(RAJA_ENABLE_OPENMP) && defined(RUN_OPENMP)
